...
public final class WechatNotifyConst {
        ...
        public static final String WECHAT_ALARM_TEMPLATE = "<font color='warning'>【报警】</font> 动态线程池告警 \n" +
        ...
        public static final String WECHAT_CHANGE_NOTICE_TEMPLATE = "<font color='info'>【通知】</font> 动态线程池参数变更 \n" +
                        "> <font color='comment'>服务名称：%s</font> \n" +
                        "> <font color='comment'>实例信息：%s</font> \n" +
                        "> <font color='comment'>环境：%s</font> \n" +
                        "> <font color='comment'>线程池名称：%s</font> \n" +
