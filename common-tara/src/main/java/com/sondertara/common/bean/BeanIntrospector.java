 ...
 * </p>
 * <p>
 * Before PropertyUtils can be used for interaction with a specific Java class,
 * the class's properties have to be determined. This is called
...
public interface BeanIntrospector {
	 ...
	 *
	 * @param icontext
	 *            the context object for interaction with the initiator of the
