...
class ExtendedBeanInfo implements BeanInfo {
	...
	static class SimplePropertyDescriptor extends PropertyDescriptor {
		...
		@Override
		public int hashCode() {
			return (ObjectUtils.hashCode(getReadMethod()) * 29 + ObjectUtils.hashCode(getWriteMethod()));
		}
	...
	static class SimpleIndexedPropertyDescriptor extends IndexedPropertyDescriptor {
		...
		public boolean equals(@Nullable Object other) {
			...
			return (ObjectUtils.equals(getIndexedReadMethod(), otherPd.getIndexedReadMethod()) &&
					ObjectUtils.equals(getIndexedWriteMethod(), otherPd.getIndexedWriteMethod()) &&
					ObjectUtils.equals(getIndexedPropertyType(), otherPd.getIndexedPropertyType()) &&
					PropertyDescriptorUtils.equals(this, otherPd));
		}

		@Override
		public int hashCode() {
			int hashCode = ObjectUtils.hashCode(getReadMethod());
			hashCode = 29 * hashCode + ObjectUtils.hashCode(getWriteMethod());
			hashCode = 29 * hashCode + ObjectUtils.hashCode(getIndexedReadMethod());
			hashCode = 29 * hashCode + ObjectUtils.hashCode(getIndexedWriteMethod());
			return hashCode;
		}
