...
import com.sondertara.common.reflect.type.ResolvableType;
...
class TypeDescriptor implements Serializable {
    ...
    public Class<?> getObjectType() {
        return TypeUtils.getPrimitiveWrapClass(getType());
    }
    ...
    public TypeDescriptor upcast(Class<?> superType) {
        if (superType == null) {
         ...
         Assert.isTrue(superType.isAssignableFrom(getType()));
    ...
    public String getName() {
        return ReflectUtils.getFQNClassName(getType());
    }
    ...
    public boolean hasAnnotation(Class<? extends Annotation> annotationType) {
        ...
        return ReflectUtils.hasAnnotation(this.annotatedElement, annotationType);
    }
    ...
    public TypeDescriptor getElementTypeDescriptor() {
        ...
        if (streamAvailable && Stream.class.isAssignableFrom(getType())){
    ...
    public TypeDescriptor getMapKeyTypeDescriptor() {
         Assert.isTrue(isMap(), "Not a [java.util.Map]");
    ...
    public TypeDescriptor getMapValueTypeDescriptor() {
        Valid.checkState(isMap(), "Not a [java.util.Map]");
