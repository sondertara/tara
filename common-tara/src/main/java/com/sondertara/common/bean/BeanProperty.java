...
import com.sondertara.common.reflect.type.GenericTypeResolver;
import com.sondertara.common.reflect.type.SimpleParameter;
...
final class BeanProperty {
    ...
    private static final Map<BeanProperty, Annotation[]> ANNOTATION_CACHE = new WeakConcurrentMap<>();
    ...
    private Annotation[] resolveAnnotations() {
        Annotation[] annotations = ANNOTATION_CACHE.get(this);
        if (annotations == null) {
            ...
            ANNOTATION_CACHE.put(this, annotations);
        }
        return annotations;
    }
    ...
    private Field getField() {
        ...
        Field field = ReflectUtils.findField(declaringClass, name);
        if (field == null) {
            // Same lenient fallback checking as in CachedIntrospectionResults...
            field = ReflectUtils.findField(declaringClass, StringUtils.uncapitalize(name));
            if (field == null) {
                field = ReflectUtils.findField(declaringClass, StringUtils.capitalize(name));
            }
        }
        return field;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (ObjectUtils.equals(this.objectType, otherProperty.objectType) &&
                ObjectUtils.equals(this.name, otherProperty.name) &&
                ObjectUtils.equals(this.readMethod, otherProperty.readMethod) &&
                ObjectUtils.equals(this.writeMethod, otherProperty.writeMethod));
    }
