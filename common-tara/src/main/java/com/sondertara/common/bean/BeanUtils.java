...
public class BeanUtils {
    ...
    public static <T,R> List<R> beansToBeans(Collection<T> sourceList, Class<R> targetClass) {
     ...
     */
    public static <T,K> List<T> mapsToBeans(List<Map<K, Object>> list, Class<T> t) {
