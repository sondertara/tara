...
abstract class BridgeMethodResolver {
    ...
    static Method findBridgedMethod(Method bridgeMethod) {
        ...
        Collection<Method> methods = ReflectUtils.getAllDeclaredMethods(declaringClass);
    ...
    private static Method findGenericDeclaration(Method bridgeMethod) {
        ...
        Set<Class> interfaces = ReflectUtils.getAllInterfaces(bridgeMethod.getDeclaringClass());
    ...
    private static Method searchInterfaces(Collection<Class> interfaces, Method bridgeMethod) {
        for (Class ifc : interfaces) {
            ...
            if (method != null && !method.isBridge()) {
                ...
                method = searchInterfaces(Lists.asList(ifc.getInterfaces()), bridgeMethod);
                if (method != null) {
                    return method;
                }
            }
    ...
    private static Method searchForMatch(Class<?> type, Method bridgeMethod) {
        return ReflectUtils.getDeclaredMethod(type,bridgeMethod.getName(), bridgeMethod.getParameterTypes());
    }
