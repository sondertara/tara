...
public class Platform {
    ...
    public static final boolean isMaxOS = OS.isMacOSX();
    ...
    private static String getProcessId0() {
        try {
            if (isAndroid) {
                ...
                return ReflectUtils.getDeclaredMethod(Class.forName("java.lang.management.RuntimeMXBean"), "getName").invoke(runtimeMXBean).toString().split("@")[0];
            } else {
