...
public class VfsResource implements Resource {
	...
	static {
		Class<?> virtualFile = ClassLoaderUtils.loadClass(VFS3_PKG + "VirtualFile");
		try {
	...
	public boolean exists() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_EXISTS);
	}

	@Override
	public String getName() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_GET_NAME);
	}

	@Override
	public URL getUrl() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_TO_URL);
	}

	@Override
	public InputStream getStream() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_GET_INPUT_STREAM);
	}
	...
	public long getLastModified() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_GET_LAST_MODIFIED);
	}
	 ...
	 */
	public long size() {
		return ReflectUtils.invoke(virtualFile, VIRTUAL_FILE_METHOD_GET_SIZE);
	}
