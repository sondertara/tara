...
import com.sondertara.common.io.resource.ResourceRegion;
...
public abstract class HttpRange {
    ...
    public static List<HttpRange> parseRanges(@Nullable String ranges) {
        if (!StringUtils.isNotEmpty(ranges)) {
    ...
    private static HttpRange parseRange(String range) {
        Valid.notNull(range, "Range String must not be empty");
    ...
    public static String toString(Collection<HttpRange> ranges) {
        Valid.notNull(ranges, "Ranges Collection must not be empty");
    ...
    private static class ByteRange extends HttpRange {
        ...
        @Override
        public int hashCode() {
            return new HashCodeBuilder().with(this.firstPos).with(this.lastPos).build();
        }
    ...
    private static class SuffixByteRange extends HttpRange {
        ...
        @Override
        public int hashCode() {
            return new HashCodeBuilder().with(this.suffixLength).build();
        }
