...
public class URLUtils {
    ...
    public static URI getStringURI(CharSequence content) {
        ...
        final String contentStr = StringUtils.addPrefixIfNot(content, "string:///");
     ...
     * @return URL
     * @throws TaraException MalformedURLException
     */
    public static URL getURL(File file) {
        ...
        try {
            ...
            throw new TaraException("Error occurred when get URL!", e);
        }
    }
    ...
    public static String decode(String content, Charset charset) {
        try {
            return URLDecoder.decode(content, charset.toString());
     ...
     * @param charset 编码
     * @return 解码后的URL
     * @throws TaraException UnsupportedEncodingException
     */
    public static String decode(String content, String charset) throws TaraException {
        return decode(content, StringUtils.isEmpty(charset) ? StandardCharsets.UTF_8 : Charset.forName(charset));
    }
     ...
     * @param uriStr URI路径
     * @return path
     * @throws TaraException 包装URISyntaxException
     */
