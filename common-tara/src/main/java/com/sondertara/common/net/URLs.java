...
import com.sondertara.common.jar.multiplelevel.MultipleLevelURLStreamHandler;
...
public class URLs {
    ...
    private static final List<String> SECURITY_PROTOCOLS = Lists.newArrayList(
            "file","jar"
    );
    public static <U extends URLConnection> U openURL(URL url) throws IOException{
        ...
        throw new IOException(StringUtils.format("unsupported protocol: {}", url.toString()));
    }
