package com.sondertara.common.net.mime;
 ...
 * {@link #valueOf(String)}. For more parsing options see {@link MimeTypes}.
 *
 * @see MimeTypes
 */
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    public MimeType(String type, String subtype, @Nullable Map<String, String> parameters) {
        Valid.notNull(type, "'type' must not be empty");
        Valid.notNull(subtype, "'subtype' must not be empty");
        checkToken(type);
        checkToken(subtype);
        this.type = type.toLowerCase(Locale.ENGLISH);
        this.subtype = subtype.toLowerCase(Locale.ENGLISH);
        if (!Emptys.isEmpty(parameters)) {
            final Map<String, String> map = new LinkedCaseInsensitiveMap<String>(parameters.size(), Locale.ENGLISH);
            CollectionUtils.forEach(parameters, new BiConsumer<String, String>() {
                @Override
                public void accept(String attribute, String value) {
    ...
    protected void checkParameters(String attribute, String value) {
        Valid.notNull(attribute, "'attribute' must not be empty");
        Valid.notNull(value, "'value' must not be empty");
    ...
    private boolean parametersAreEqual(MimeType other) {
        ...
        for (Map.Entry<String, String> entry : this.parameters.entrySet()) {
            ...
            } else if (!ObjectUtils.equals(entry.getValue(), other.parameters.get(key))) {
                return false;
            }
        }
    ...
    private void appendTo(Map<String, String> map, final StringBuilder builder) {
     ...
     * @see MimeTypes#sortBySpecificity(List)
     */
    @Override
     ...
     *
     * @see MimeTypes#parseMimeType(String)
     */
    ...
    public static class SpecificityComparator<T extends MimeType> implements Comparator<T>, Serializable {
        ...
        protected int compareParameters(T mimeType1, T mimeType2) {
            ...
            return paramsSize2 - paramsSize1;  // audio/basic;level=1 < audio/basic
        }
    }
