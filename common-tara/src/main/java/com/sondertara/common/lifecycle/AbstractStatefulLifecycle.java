...
import com.sondertara.common.concurrent.lock.AutoLock;
...
import com.sondertara.common.os.Uptime;
...
public abstract class AbstractStatefulLifecycle implements StatefulLifecycle, EventPublisherAware {
    ...
    private void setStarted() {
        if (state == State.STARTING) {
            ...
            List<EventListener<DomainEvent<?>>> listeners = publisher.getListeners(this.domain);
    ...
    public String toString() {
        ...
        if (StringUtils.isBlank(name) && getClass().getSuperclass() != null) {
