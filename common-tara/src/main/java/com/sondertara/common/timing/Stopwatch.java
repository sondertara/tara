...
package com.sondertara.common.timing;
...
public final class Stopwatch {
    ...
    public Stopwatch start() {
        Valid.checkState(!isRunning, "This stopwatch is already running.");
        isRunning = true;
    ...
    public Stopwatch stop() {
        ...
        Valid.checkState(isRunning, "This stopwatch is already stopped.");
        isRunning = false;
    ...
    public long elapsedSeconds() {
        return SECONDS.convert(elapsedNanos,NANOSECONDS);
    }
