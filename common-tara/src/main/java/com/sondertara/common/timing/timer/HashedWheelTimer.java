...
import com.sondertara.common.memory.leak.ResourceLeakDetector;
import com.sondertara.common.memory.leak.ResourceLeakDetectorFactory;
import com.sondertara.common.memory.leak.ResourceLeakTracker;
import com.sondertara.common.os.JdkUtils;
import com.sondertara.common.reflect.ReflectUtils;
import com.sondertara.common.retry.ThreadSleepWaitStrategy;
import com.sondertara.common.retry.WaitStrategy;
...
public class HashedWheelTimer extends AbstractTimer {
    ...
    public HashedWheelTimer(long tickDuration,TimeUnit unit, int ticksPerWheel, Executor threadPoolExecutor) {
        this(Executors.defaultThreadFactory(), tickDuration, unit, ticksPerWheel, false,-1,threadPoolExecutor);
    }
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long tickDuration, TimeUnit unit, int ticksPerWheel, boolean leakDetection, long maxPendingTimeouts, Executor taskExecutor, TimeoutFactory<HashedWheelTimer, ? extends HashedWheelTimeout> timeoutFactory, WaitStrategy waitStrategy) {
        ...
        this.timeoutFactory = ObjectUtils.defaultIfEmpty(timeoutFactory, HashedWheelTimeoutFactory.INSTANCE);
    ...
    private static void reportTooManyInstances() {
        ...
        if (logger.isErrorEnabled()) {
            String resourceType = ReflectUtils.getSimpleClassName(HashedWheelTimer.class);
