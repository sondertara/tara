...
public abstract class GenericTypeResolver {
     ...
     * @deprecated as of Spring 4.0, use {@link SimpleParameter#getGenericParameterType()}
     */
    @Deprecated
    public static Type getTargetType(SimpleParameter methodParameter) {
     ...
     */
    public static Class<?> resolveParameterType(SimpleParameter methodParameter, Class<?> implementationClass) {
        Objects.requireNonNull(methodParameter, "MethodParameter must not be null");
        Objects.requireNonNull(implementationClass, "Class must not be null");
