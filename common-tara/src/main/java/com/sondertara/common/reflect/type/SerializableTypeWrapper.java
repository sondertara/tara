...
public abstract class SerializableTypeWrapper {
    ...
    private static final class TypeProxyInvocationHandler implements InvocationHandler, Serializable {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (Type.class == method.getReturnType() && args == null) {
                ...
                Type[] types = ReflectUtils.<Type[]>invokeMethod(method, obj, args);
            ...
            return ReflectUtils.invokeMethod(method, this.provider.getType(), args);
        }
    }
    ...
    public static final class FieldTypeProvider implements TypeProvider {
        ...
        private void readObject(ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
            ...
            this.field = ReflectUtils.getDeclaredField(this.declaringClass, this.fieldName);
            if (this.field == null) {
                throw new IllegalStateException(StringUtils.format("Could not find field {} in class {}", this.fieldName, ReflectUtils.getFQNClassName(this.declaringClass)));
            }
        }
    }
        ...
        private void readObject(ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
            ...
            try {
                if (this.methodName != null) {
                    this.methodParameter = new SimpleParameter(ReflectUtils.getDeclaredMethod(this.declaringClass, this.methodName, this.parameterTypes)
                            , this.parameterIndex);
                } else {
    ...
    public static final class MethodInvokeTypeProvider implements TypeProvider {
        ...
        public Type getType() {
            ...
            if (result == null) {
                ...
                result = ReflectUtils.invoke(this.method, this.provider.getType(), Emptys.EMPTY_OBJECTS, true);
        ...
        private void readObject(ObjectInputStream inputStream) throws IOException, ClassNotFoundException {
            inputStream.defaultReadObject();
            this.method = ReflectUtils.findMethod(this.declaringClass, this.methodName);
