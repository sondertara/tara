...
import com.sondertara.common.reflect.parameter.ConstructorParameterSupplier;
import com.sondertara.common.reflect.parameter.MethodParameter;
import com.sondertara.common.reflect.parameter.MethodParameterSupplier;
import com.sondertara.common.reflect.parameter.ParameterMeta;
import com.sondertara.common.reflect.parameter.ParameterSupplier;
...
public class ParameterServiceRegistry implements Registry<String, ParameterSupplier> {
    ...
    private static void loadMethodParameterSuppliers() {
        ...
        CollectionUtils.forEach(loader, new Consumer<MethodParameterSupplier>() {
            @Override
    ...
    private static void loadConstructorParameterSuppliers() {
        ...
        CollectionUtils.forEach(loader, new Consumer<ConstructorParameterSupplier>() {
            @Override
    ...
    public MethodParameter getMethodParameter(String supplierName, String name, int modifiers, Method method, int index) {
        return findMethodParameterSupplier(supplierName, true).apply(new ParameterMeta(name, modifiers, method, index));
    }
    ...
    public ConstructorParameter getConstructorParameter(String supplierName, String name, int modifiers, Constructor constructor, int index) {
        return findConstructorParameterSupplier(supplierName, true).apply(new ParameterMeta(name, modifiers, constructor, index));
    }
    ...
    private static void registerInternal(ConstructorParameterSupplier supplier) {
        ...
        String name = ReflectUtils.getFQNClassName(clazz);
        constructorParameterSupplierRegistry.put(name, supplier);
        if (ReflectUtils.hasAnnotation(clazz, Name.class)) {
            Name nameAnno = ReflectUtils.getAnnotation(clazz, Name.class);
            name = nameAnno.value();
            constructorParameterSupplierRegistry.put(name, supplier);
        }
    }
