...
import com.sondertara.common.function.ISetter;
...
public class LambdaUtils {
    ...
    public static <T> Class<T> getImplClass(SerializedLambda lambda) {
        return (Class<T>) ClassUtils.loadClass(getImplClassName(lambda));
    }
    ...
    public static String getFieldName(SerializedLambda lambda) {
        return ClassUtils.getFieldNameByMethodName(lambda.getImplMethodName());
    }
    ...
    public static Field getField(SerializedLambda lambda) {
        ...
        // 字段名称
        String fieldName = ClassUtils.getFieldNameByMethodName(lambda.getImplMethodName());
        // 获取字段
        return ClassUtils.getAccessibleField(clazz, fieldName);
    }
    ...
    public static Method getMethod(SerializedLambda lambda) {
        ...
        throw new TaraException("no such method in class: " + clazz + " method signature: " + signature);
    }
