//package com.sondertara.common.reflect.reflection.util;
//
...
//				() -> new IllegalArgumentException("Failed to find a component in " + recordClass.getName() + " for the given component accessor."));
...
//		Assert.isTrue(recordClass.isRecord(), () -> new IllegalArgumentException(recordClass + " is not a record"));
...
//				() -> new IllegalArgumentException("Expected one property descriptor but got " + propertyDescriptors.length));
