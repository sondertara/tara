package com.sondertara.common.reflect.signature;
...
public class TypeSignatures {
    ...
    public static String toTypeSignature(Class clazz) {
        return toTypeSignature(ReflectUtils.getFQNClassName(clazz));
    }
    ...
    public static String toMethodSignature(Method method){
        ...
        String declaringClassSignature = ReflectUtils.getFQNClassName(declaringClass).replace('.','/');
