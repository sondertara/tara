...
public class ResolvableType implements Serializable {
    ...
    private ResolvableType(
            Type type, SerializableTypeWrapper.TypeProvider typeProvider, VariableResolver variableResolver, ResolvableType componentType) {
     ...
     * {@link SimpleParameter} or {@link Type} depending on how the {@link ResolvableType}
    ...
    private boolean isAssignableFrom(ResolvableType other, Map<Type, Type> matchedBefore) {
        Objects.requireNonNull(other, "ResolvableType must not be null");
     ...
     * The result will be {@code true} only in those two scenarIOUtils.
     */
    ...
    public boolean equals(Object other) {
        ...
        return ObjectUtils.equals(this.componentType, otherType.componentType);
    }
    ...
    public String toString() {
        ...
        if (hasGenerics()) {
            result.append('<');
            result.append(StringUtils.join(", ",getGenerics()));
            result.append('>');
        }
    ...
    public static ResolvableType forRawClass(Class<?> clazz) {
        return new ResolvableType(clazz) {
            ...
            @Override
            public boolean isAssignableFrom(Class<?> other) {
                return getRawClass().isAssignableFrom( other);
            }
            @Override
            public boolean isAssignableFrom(ResolvableType other) {
                Class<?> otherClass = other.getRawClass();
                return (otherClass != null && getRawClass().isAssignableFrom( otherClass));
            }
        };
    }
    ...
    public static ResolvableType forClass(Class<?> baseType, Class<?> implementationClass) {
        Objects.requireNonNull(baseType, "Base type must not be null");
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, Class<?>... generics) {
        ...
        Objects.requireNonNull(generics, "Generics array must not be null");
    ...
    public static ResolvableType forConstructorParameter(Constructor<?> constructor, int parameterIndex) {
        ...
        return forMethodParameter(new SimpleParameter(constructor, parameterIndex));
    }
    ...
    public static ResolvableType forConstructorParameter(Constructor<?> constructor, int parameterIndex,
        ...
        Objects.requireNonNull(constructor, "Constructor must not be null");
        SimpleParameter methodParameter = new SimpleParameter(constructor, parameterIndex);
    ...
    public static ResolvableType forMethodReturnType(Method method) {
        ...
        return forMethodParameter(new SimpleParameter(method, -1));
    }
    ...
    public static ResolvableType forMethodReturnType(Method method, Class<?> implementationClass) {
        Objects.requireNonNull(method, "Method must not be null");
        SimpleParameter methodParameter = new SimpleParameter(method, -1);
        methodParameter.setContainingClass(implementationClass);
        return forMethodParameter(methodParameter);
    }
     ...
     * @see #forMethodParameter(SimpleParameter)
     */
    public static ResolvableType forMethodParameter(Method method, int parameterIndex) {
        Objects.requireNonNull(method, "Method must not be null");
        return forMethodParameter(new SimpleParameter(method, parameterIndex));
    }
    ...
    public static ResolvableType forMethodParameter(Method method, int parameterIndex, Class<?> implementationClass) {
        Objects.requireNonNull(method, "Method must not be null");
        SimpleParameter methodParameter = new SimpleParameter(method, parameterIndex);
        methodParameter.setContainingClass(implementationClass);
        return forMethodParameter(methodParameter);
    }

    /**
     * Return a {@link ResolvableType} for the specified {@link SimpleParameter}.
     * @param methodParameter the source method parameter (must not be {@code null})
     * @return a {@link ResolvableType} for the specified method parameter
     * @see #forMethodParameter(Method, int)
     */
    public static ResolvableType forMethodParameter(SimpleParameter methodParameter) {
        return forMethodParameter(methodParameter, (Type) null);
    }

    /**
     * Return a {@link ResolvableType} for the specified {@link SimpleParameter} with a
     ...
     * @see #forMethodParameter(SimpleParameter)
     */
    public static ResolvableType forMethodParameter(SimpleParameter methodParameter, ResolvableType implementationType) {
        Objects.requireNonNull(methodParameter, "MethodParameter must not be null");
     ...
     * @see #forMethodParameter(Method, int)
     */
    public static ResolvableType forMethodParameter(SimpleParameter methodParameter, Type targetType) {
        Objects.requireNonNull(methodParameter, "MethodParameter must not be null");
     ...
     *      * @see SimpleParameter#setParameterType
     */
    static void resolveMethodParameter(SimpleParameter methodParameter) {
        Objects.requireNonNull(methodParameter, "MethodParameter must not be null");
        ResolvableType owner = forType(methodParameter.getContainingClass()).as(methodParameter.getDeclaringClass());
