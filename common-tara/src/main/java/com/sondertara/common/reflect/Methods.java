...
import com.sondertara.common.reflect.type.TypeInfer;
...
public class Methods {
    ...
    private static final Map<Class<?>, List<Method>> CLASS_SET_METHOD_CACHE = new ConcurrentReferenceHashMap<>(16, ReferenceType.SOFT,ReferenceType.SOFT);

    private static final Map<Class<?>, List<Method>> CLASS_GET_METHOD_CACHE = new ConcurrentReferenceHashMap<>(16, ReferenceType.SOFT,ReferenceType.SOFT);
    ...
    public static Method getGetterMethodByCache(Class<?> clazz, String field) {
        ...
        String methodName1 = GETTER_PREFIX + StringUtils.upperFirst(field);
        for (Method method : methods) {
            if (method.getParameterCount() == 0 && method.getName().equals(methodName1)) {
                return method;
            }
        }
        String methodName2 = BOOLEAN_GETTER_PREFIX + StringUtils.upperFirst(field);
        for (Method method : methods) {
    ...
    public static Method getSetterMethodByCache(Class<?> clazz, String field) {
        ...
        String methodName = SETTER_PREFIX + StringUtils.upperFirst(field);
        for (Method method : methods) {
    ...
    public static String getGetterMethodNameByFieldName(String fieldName) {
        ...
        return GETTER_PREFIX + StringUtils.upperFirst(fieldName.trim());
    }
    ...
    public static String getGetterMethodNameByFieldName(String fieldName, boolean isBooleanClass) {
        ...
        return (isBooleanClass ? BOOLEAN_GETTER_PREFIX : GETTER_PREFIX) + StringUtils.upperFirst(fieldName.trim());
    }
    ...
    public static String getSetterMethodNameByField(Field field) {
        return SETTER_PREFIX + StringUtils.upperFirst(field.getName());
    }
    ...
    public static String getSetterMethodNameByFieldName(String fieldName) {
        ...
        return SETTER_PREFIX + StringUtils.upperFirst(fieldName.trim());
    }
        ...
        for (Field field : fields) {
            if (!Modifier.isStatic(field.getModifiers())) {
                ...
                if (field.getType().equals(Boolean.TYPE)) {
                    String fieldName = StringUtils.upperFirst(field.getName());
                    ...
                    method = getAccessibleMethod(clazz, GETTER_PREFIX + StringUtils.upperFirst(field.getName()), 0);
                }
                if (method != null) {
                    list.add(method);
                }
    ...
    public static List<Method> getSetterMethodsByField(Class<?> clazz) {
        ...
        for (Field field : fields) {
            if (!Modifier.isStatic(field.getModifiers())) {
                String methodName = SETTER_PREFIX + StringUtils.upperFirst(field.getName());
    ...
    public static Method getGetterMethodByField(Class<?> clazz, Field field) {
        ...
        if (field.getType().equals(Boolean.TYPE)) {
            ...
            String methodName = GETTER_PREFIX + StringUtils.upperFirst(field.getName());
    ...
    public static Method getGetterMethodByFieldName(Class<?> clazz, String fieldName) {
        ...
        fieldName = StringUtils.upperFirst(fieldName.trim());
    ...
    public static Method getSetterMethodByFieldName(Class<?> clazz, String fieldName) {
        ...
        String methodName = SETTER_PREFIX + StringUtils.upperFirst(fieldName);
    ...
    public static Map<String, Method> getAccessibleMethodMap(Class<?> clazz) {
        ...
        return CollectionUtils.isNotEmpty(methodList) ? methodList.stream().collect(Collectors.toMap(Method::getName, identity())) : new HashMap<>();
    }
    ...
    public static <E> E invokeGetter(Object obj, String fieldName) {
        ...
        try {
            Field field = ClassUtils.getAccessibleField(obj.getClass(), fieldName);
            if (field == null || !field.getType().equals(Boolean.TYPE)) {
                return invokeMethod(obj, GETTER_PREFIX + StringUtils.upperFirst(fieldName), null, (Object[]) null);
            } else {
                return invokeMethod(obj, BOOLEAN_GETTER_PREFIX + StringUtils.upperFirst(fieldName), null, (Object[]) null);
            }
        } catch (Exception e) {
            throw new IllegalStateException(StringUtils.format("invoke field: {} setter method error {}", fieldName, e.getMessage()), e);
        }
    }
    ...
    public static <E, R> R invokeSetter(Object obj, String fieldName, E value) {
        return (R) invokeMethod(obj, SETTER_PREFIX + StringUtils.upperFirst(fieldName), new Class[]{value.getClass()}, new Object[]{value});
    }
    ...
    public static <E, R> R invokeSetter(Object obj, String fieldSetterMethodName, E... values) {
        ...
        if (names.length != ArrayUtils.length(values)) {
            throw new IllegalArgumentException("setting method and parameter length are inconsistent");
        }
        if (names.length == 1) {
            return (R) invokeMethod(obj, SETTER_PREFIX + StringUtils.upperFirst(names[0]), new Class[]{values[0].getClass()}, new Object[]{values[0]});
        } else {
    ...
    public static <E, R> R invokeSetterInfer(Object obj, String fieldName, E value) {
        return invokeMethodInfer(obj, SETTER_PREFIX + StringUtils.upperFirst(fieldName), new Object[]{value});
    }
    ...
    public static <E> E invokeMethod(Object obj, String methodName, Class<?>[] parameterTypes, Object... args) {
        ...
        if (method == null) {
            throw new IllegalStateException(StringUtils.format("method {} not found in class {}", methodName, obj.getClass()));
        }
        try {
            return (E) method.invoke(obj, args);
        } catch (Exception e) {
            throw new IllegalStateException(StringUtils.format("invoke method error: {}, class: {}, args: {}", methodName, obj.getClass(), Arrays.toString(args)), e);
        }
    }
    ...
    public static <E> E invokeMethod(Object obj, String methodName, Object... args) {
        ...
        if (method == null) {
            throw new IllegalStateException(StringUtils.format("invoke method error: {} not found in class {}", methodName, obj.getClass().getName()));
        }
        try {
            return (E) method.invoke(obj, args);
        } catch (Exception e) {
            throw new IllegalStateException(StringUtils.format("invoke method error: {}, class: {}, args: {}", methodName, obj.getClass().getName(), Arrays.toString(args)), e);
        }
    }
    ...
    public static <E> E invokeMethod(Object obj, Method method, Object... args) {
        ...
        try {
            ...
            throw new IllegalStateException(StringUtils.format("invoke method error: {}, class: {}, args: {}", method.getName(), obj.getClass().getName(), Arrays.toString(args)), e);
        }
    }
    ...
    public static <E> E invokeMethodInfer(Object obj, Method method, Object... args) {
        ...
        return TypeInfer.invokeInfer(obj, Collections.singletonList(method), args);
    }
    ...
    public static <E> E invokeMethodInfer(Object obj, String methodName, Object... args) {
        ...
        int len = ArrayUtils.length(args);
