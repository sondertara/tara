...
package com.sondertara.common.codec.base32;

import com.sondertara.common.text.StringUtils;
import com.sondertara.common.codec.BaseNCodec;
import com.sondertara.common.codec.CodecPolicy;
...
public class Base32 extends BaseNCodec {
     ...
     * </p>
     * <p>
     * Output is written to { BaseNCodec.Context#buffer BaseNCodec.Context#buffer} as 8-bit
     * octets, using { BaseNCodec.Context#pos BaseNCodec.Context#pos} as the buffer position
     * </p>
     *
     ...
     */
    @Override
    public void decode(final byte[] input, int inPos, final int inAvail, final Context context) {
...
//              case 0 : // impossible, as excluded above
     ...
     */
    @Override
    public void encode(final byte[] input, int inPos, final int inAvail, final Context context) {
        // package protected for access from I/O streams
