package com.sondertara.common.codec.morse;
...
public class Morse {
    ...
    private static final Map<Integer, String> ALPHABETS = new HashMap<Integer, String>(); // code point -> morse
    private static final Map<String, Integer> DICTIONARIES = new HashMap<String, Integer>(); // morse -> code point
     ...
     */
    public Morse() {
        this(CharUtils.DOT, CharUtils.DASHED, CharUtils.SLASH);
    }
    ...
    public String decode(String morse) {
        Objects.requireNonNull(morse, "Morse should not be null.");
        ...
        final List<String> words = StringUtils.split(morse, split, false, false);
