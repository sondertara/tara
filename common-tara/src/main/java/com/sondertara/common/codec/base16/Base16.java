...
public class Base16 extends BaseNCodec {
    ...
    @Override
    public void decode(final byte[] data, int offset, final int length, final Context context) {
