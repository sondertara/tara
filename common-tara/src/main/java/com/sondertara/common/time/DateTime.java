...
public class DateTime extends Date {
    ...
    public DateTime(Instant instant, ZoneId zoneId) {
        this(instant.toEpochMilli(), TimeZone.getTimeZone(zoneId));
    }
    ...
    public DateTime(TemporalAccessor temporalAccessor) {
        this(toInstant(temporalAccessor));
    }
    ...
    public DateTime(String dateStr) {
        this(LocalDateTimeUtils.parse(dateStr));
    }
    ...
    public DateTime(CharSequence dateStr, String format) {
        this(parse(dateStr, LocalDateTimeUtils.newSimpleFormat(format)));
    }
    ...
    public DateTime(CharSequence dateStr, DateTimeFormatter formatter) {
        this(TemporalAccessorUtils.toInstant(formatter.parse(dateStr)), formatter.getZone());
    }
    ...
    public void setTime(long time) {
        if (mutable) {
            ...
            throw new IllegalArgumentException("This is not a mutable object !");
        }
    }
    ...
    public boolean isLeapYear() {
        return LocalDateTimeUtils.isLeapYear(year());
    }
     ...
     * @return 相差时长
     */
    public long between(Date date, TimeUnit unit) {
     ...
     * 如果{@link #useJdkToStringStyle}为{@code true}，返回"EEE MMM dd HH:mm:ss zzz
     * yyyy"格式，<br>
    ...
    public String toString(TimeZone timeZone) {
        if (null != timeZone) {
            return toString(LocalDateTimeUtils.newSimpleFormat(DatePattern.NORM_DATETIME_PATTERN, null, timeZone));
        }
    ...
    public String toDateStr() {
        if (null != this.timeZone) {
            return toString(LocalDateTimeUtils.newSimpleFormat(DatePattern.NORM_DATE_PATTERN, null, timeZone));
        }
    ...
    public String toTimeStr() {
        if (null != this.timeZone) {
            return toString(LocalDateTimeUtils.newSimpleFormat(DatePattern.NORM_TIME_PATTERN, null, timeZone));
        }
    ...
    public String toString(String format) {
        if (null != this.timeZone) {
            return toString(LocalDateTimeUtils.newSimpleFormat(format, null, timeZone));
        }
    ...
    private static Date parse(CharSequence dateStr, DateFormat dateFormat) {
        ...
        try {
            ...
            throw ErrorUtils.illegalArgumentException(
                    StringUtils.format("Parse [{}] with format [{}] error!", dateStr, pattern), e);
        }
    }
    ...
    private static Calendar parse(CharSequence dateStr, DateParser parser, boolean lenient) {
        ...
        final Calendar calendar = CalendarUtils.parse(dateStr, lenient, parser);
        if (null == calendar) {
            throw ErrorUtils.illegalArgumentException("Parse [{}] with format [{}] error!", dateStr,
                    parser.getPattern());
        }
