...
public class AntPathMatcher extends AbstractPatternSetMatcher<StringPatternEntry> implements PathMatcher {
    ...
    public AntPathMatcher(@Nullable String defaultPatternExpression) {
        this(new GenericPatternSetExpressionParser<>(StringPatternEntry::new), defaultPatternExpression);
    }

    public AntPathMatcher(@Nullable String defaultPatternExpression, @NonNull String patternExpression) {
        super(new GenericPatternSetExpressionParser<>(StringPatternEntry::new), defaultPatternExpression, patternExpression);
    }
