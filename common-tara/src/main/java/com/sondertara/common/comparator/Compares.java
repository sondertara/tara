...
public class Compares {
    ...
    public static <E> boolean gt(E e1, E e2) {
        if (!e1.getClass().isAssignableFrom( e2.getClass()) && !e2.getClass().isAssignableFrom( e1.getClass())) {
            throw new UnsupportedOperationException(StringUtils.format("unsupported operation > between {} and  {}", e1.getClass(), e2.getClass()));
        }
     ...
     * grater or equals
     */
    public static <E> boolean gte(E e1, E e2) {
        if (e1.equals(e2)) {
            return true;
        }
        if (!e1.getClass().isAssignableFrom( e2.getClass()) && !e2.getClass().isAssignableFrom(e1.getClass())) {
     ...
     * letter or equals
     */
    public static <E> boolean lte(E e1, E e2) {
        if (e1.equals(e2)) {
            return true;
        }
        if (!e1.getClass().isAssignableFrom(e2.getClass()) && !e2.getClass().isAssignableFrom( e1.getClass())) {
    ...
    public static <E> boolean in(E e1, Object collection) {
        return CollectionUtils.asCollection(CollectionUtils.asIterable(collection)).contains(e1);
    }
