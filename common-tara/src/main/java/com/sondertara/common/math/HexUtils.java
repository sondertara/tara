...
public class HexUtils {
    ...
    public static char[] encode(String str, Charset charset) {
        return encode(StringUtils.bytes(str, charset), true);
    }
    ...
    public static byte[] decode(String hexData) {
    ...
    public static String decodeHexStr(String hexStr) {
        return decode(hexStr, StandardCharsets.UTF_8);
    }
     ...
     * @return 字符串
     */
    public static String decode(String hexStr, Charset charset) {
        if (StringUtils.isEmpty(hexStr)) {
            return hexStr;
        }
        return StringUtils.str(decode(hexStr), charset);
    }
     ...
     * @return 字符串
     */
    public static String decode(char[] hexData, Charset charset) {
        return StringUtils.str(decode(hexData), charset);
    }
