...
public class Numbers {
    ...
    public static <T extends Number> T parseNumber(String text, Class<T> targetClass) {
        ...
        String trimmed = StringUtils.deleteWhitespace(text);
    ...
    public static <T extends Number> T parseNumber(
        ...
        if (numberFormat != null) {
            ...
            try {
                Number number = numberFormat.parse(StringUtils.deleteWhitespace(text));
    ...
    public static boolean isDouble(Number number) {
        ...
        return StringUtils.containsAny(number.toString(), ".");
    }
