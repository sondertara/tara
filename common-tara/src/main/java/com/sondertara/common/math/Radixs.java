...
public class Radixs {
    ...
    private static Regexp OCTAL_STRING_PATTERN = RegexUtils.createRegexp("^[0-7]+$");
    ...
    public static String toHex2(byte b) {
        return StringUtils.completingLength(toRadix(b, 16), 2, '0', true);
    }
    ...
    public static String toHex2(long b) {
        return StringUtils.completingLength(toRadix(Numbers.toInt(b), 16), 2, '0', true);
    }
