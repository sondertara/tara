...
public class OpensslKeyUtil {
     ...
     *     <li>{@link org.bouncycastle.pkcs.PKCS10CertificationRequest}</li>
     * </ul>
     *
    ...
    private static Key readPemKeyFromKeyObject(final Object keyObject, final char[] password) throws CryptoException {
        ...
        } else if (keyObject instanceof org.bouncycastle.pkcs.PKCS10CertificationRequest) {
            // PKCS#10 CSR
            return getPublicKey(((org.bouncycastle.pkcs.PKCS10CertificationRequest) keyObject).getSubjectPublicKeyInfo());
        } else {
            // 表示无法识别的密钥类型
