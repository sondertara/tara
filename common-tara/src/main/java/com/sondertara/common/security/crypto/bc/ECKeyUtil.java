...
public class ECKeyUtil {
	...
	public static PublicKey decodeECPoint(final byte[] encodeByte, final String curveName) {
		...
		return KeyUtils.generatePublicKey("EC", new ECPublicKeySpec(point, ecSpec));
	}
	...
	public static ECPublicKeyParameters toPublicParams(final String pointEncoded, final ECDomainParameters domainParameters) {
		final ECCurve curve = domainParameters.getCurve();
		return toPublicParams(curve.decodePoint(SecureUtils.decode(pointEncoded)), domainParameters);
	}
	 ...
	 * @since 5.4.3
	 */
	public static ECPublicKeyParameters toPublicParams(final ECPoint point, final ECDomainParameters domainParameters) {
	...
	public static PrivateKey toSm2PrivateKey(final ECPrivateKey privateKey) {
		try {
			...
			return KeyUtils.generatePrivateKey("SM2", info.getEncoded());
