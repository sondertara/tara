...
package com.sondertara.common.security.crypto.digest.otp;
...
public class HOTP {
    ...
    public static String generateSecretKey(final int numBytes) {
        return Base32.toBase32String(RandomUtils.getSHA1PRNGRandom(RandomUtils.randomBytes(256)).generateSeed(numBytes));
    }
