...
public class BaseAsymmetric<T extends BaseAsymmetric<T>> implements Serializable {
	...
	@SuppressWarnings("unchecked")
	public T initKeys() {
		final KeyPair keyPair = KeyUtils.generateKeyPair(this.algorithm);
	...
	public String getPublicKeyBase64() {
		...
		return (null == publicKey) ? null : Base64.encodeBase64String(publicKey.getEncoded());
	}
	...
	public String getPrivateKeyBase64() {
		...
		return (null == privateKey) ? null : Base64.encodeBase64String(privateKey.getEncoded());
	}
