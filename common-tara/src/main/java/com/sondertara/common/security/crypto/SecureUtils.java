...
import com.sondertara.common.base.ByteUtil;
...
import com.sondertara.common.security.crypto.asymmetric.AsymmetricAlgorithm;
import com.sondertara.common.security.crypto.asymmetric.RSA;
import com.sondertara.common.security.crypto.digest.DigestAlgorithm;
import com.sondertara.common.security.crypto.digest.Digester;
import com.sondertara.common.security.crypto.digest.MD5;
import com.sondertara.common.security.crypto.digest.mac.HMac;
import com.sondertara.common.security.crypto.digest.mac.HmacAlgorithm;
import com.sondertara.common.security.crypto.provider.GlobalProviderFactory;
import com.sondertara.common.security.crypto.symmetric.AES;
import com.sondertara.common.security.crypto.symmetric.DES;
import com.sondertara.common.security.crypto.symmetric.DESede;
import com.sondertara.common.security.crypto.symmetric.FPE;
import com.sondertara.common.security.crypto.symmetric.PBKDF2;
import com.sondertara.common.security.crypto.symmetric.SymmetricAlgorithm;
import com.sondertara.common.security.crypto.symmetric.SymmetricCrypto;
import com.sondertara.common.security.crypto.symmetric.ZUC;
...
public class SecureUtils {
	...
	public static byte[] decode(final String key) {
		...
		final boolean decodeHex = Boolean.parseBoolean(SystemPropertys.get(HUTOOL_CRYPTO_DECODE_HEX, "true"));
		return (decodeHex && HexUtils.isHexNumber(key)) ? Hex.decode(key) : Base64.decodeBase64(key);
	}
