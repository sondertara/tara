...
package com.sondertara.common.security.crypto.digest;
...
public class DigesterFactory {
	...
	public static DigesterFactory ofJdk(final String algorithm) {
		return of(SecureUtils.createJdkMessageDigest(algorithm));
	}
	...
	public static DigesterFactory of(final String algorithm) {
		return of(SecureUtils.createMessageDigest(algorithm, null));
	}

	/**
	 * 创建工厂
	 *
	 * @param messageDigest {@link MessageDigest}，可以通过{@link SecureUtils#createMessageDigest(String, Provider)} 创建
	 * @return DigesterFactory
	 */
	...
	public MessageDigest createMessageDigester() {
		...
		return SecureUtils.createJdkMessageDigest(prototype.getAlgorithm());
	}
