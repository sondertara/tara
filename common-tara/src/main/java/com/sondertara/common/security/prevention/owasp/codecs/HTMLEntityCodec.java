...
public class HTMLEntityCodec extends AbstractIntegerCodec {
    ...
    private Integer getNamedEntity(PushbackSequence<Integer> input) {
        ...
        if (entry == null) {
            ...
            if (!ObjectUtils.equals(possibleString, possibleStringLowerCase)) {
                Entry<CharSequence, Integer> exactEntry = entityToCharacterTrie.getLongestMatch(possibleStringLowerCase);
    ...
    private static synchronized Trie<Integer> mkEntityToCharacterTrie() {
        ...
        for (Entry<Integer, String> entry : characterToEntityMap.entrySet())
