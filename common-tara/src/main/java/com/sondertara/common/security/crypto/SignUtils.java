...
import com.sondertara.common.collection.MapUtils;
import com.sondertara.common.security.crypto.asymmetric.AsymmetricAlgorithm;
import com.sondertara.common.security.crypto.asymmetric.Sign;
import com.sondertara.common.security.crypto.asymmetric.SignAlgorithm;
...
public class SignUtils {
	...
	public static Signature createSignature(final AsymmetricAlgorithm asymmetricAlgorithm, final DigestAlgorithm digestAlgorithm) {
		return createSignature(SecureUtils.generateAlgorithm(asymmetricAlgorithm, digestAlgorithm));
	}
