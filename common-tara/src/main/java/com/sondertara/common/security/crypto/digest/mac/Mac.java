...
package com.sondertara.common.security.crypto.digest.mac;
...
public class Mac implements Serializable {
    ...
    public String digestBase64(final String data, final Charset charset, final boolean isUrlSafe) {
        ...
        return isUrlSafe ? java.util.Base64.getUrlEncoder().withoutPadding().encodeToString(digest) : Base64.encodeBase64String(digest);
    }
    ...
    /**
     * 生成文件摘要<br>
     * 使用默认缓存大小，见 {@link com.sondertara.common.io.IOUtils#DEFAULT_BUFFER_SIZE}
     *
     * @param file 被摘要文件
     * @return 摘要bytes
