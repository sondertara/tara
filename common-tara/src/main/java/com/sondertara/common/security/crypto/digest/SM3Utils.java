...
public class SM3Utils {
    ...
    public static String encrypt(String src) {
        return HexUtils.encodeHexStr(getEncryptBySrcByte(src.getBytes()));
    ...
    public static String encrypt(String src, String key) {
        return HexUtils.encodeHexStr(getEncryptByKey(src, key));
    ...
    public static boolean verify(String src, String sm3HexStr) throws Exception {
        byte[] sm3HashCode = HexUtils.decode(sm3HexStr);
