...
public class ClassPathResource extends AbstractLocatableResource<URL> {
    ...
    public ClassPathResource(String path, @Nullable ClassLoader classLoader) {
        ...
        if (!path.startsWith(PREFIX)) {
            ...
            throw new IllegalArgumentException(StringUtils.format("illegal path {}", path0));
        }

         Assert.isTrue(path.startsWith(PREFIX), "not a classpath resource");
    ...
    public ClassPathResource(String path, @Nullable Class<?> clazz) {
        ...
        if (!path.startsWith(PREFIX)) {
            if (path.startsWith("/")) {
                ...
                if (clazz != null) {
                    String packageName = ReflectUtils.getPackageName(clazz);
    ...
    public boolean equals(Object obj) {
        ...
        return ObjectUtils.equals(this.getLocation(), o2.getLocation());
    }
