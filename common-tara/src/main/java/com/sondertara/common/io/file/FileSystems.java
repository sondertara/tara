...
public class FileSystems {
    ...
    public static boolean hasFreeSpace(final File path, final long size) {
        ...
        if (freeSpace == 0L && JdkUtils.IS_WINDOWS) {
    ...
    public static boolean isSymlink(final File file) {
        ...
        try {
            ...
            Object filePathObject = ReflectUtils.invokePublicMethod(file, "toPath", null, null, false);
            return ReflectUtils.<Boolean>invokeAnyStaticMethod("java.nio.file.Files", "isSymbolicLink", new Class[]{pathClass}, new Object[]{filePathObject}, true, false);
        } catch (Throwable ex) {
            return false;
        }
    }
