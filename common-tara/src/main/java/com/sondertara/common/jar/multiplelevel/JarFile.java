...
public class JarFile extends java.util.jar.JarFile {
    ...
    private JarFile(RandomAccessDataFile rootFile, String pathFromRoot, RandomAccessData data, JarEntryFilter filter,
        ...
        this.manifestSupplier = (manifestSupplier != null) ? manifestSupplier : new Supplier<Manifest>() {
            @Override
            public Manifest get() {
                InputStream inputStream = null;
                try {
                    inputStream = getInputStream(MANIFEST_NAME);
                    if (inputStream == null) {
                        return null;
                    }
    ...
    void setupEntryCertificates(JarEntry entry) {
        ...
        try {
            ...
            try {
                inputStream = new JarInputStream(getData().getInputStream());
