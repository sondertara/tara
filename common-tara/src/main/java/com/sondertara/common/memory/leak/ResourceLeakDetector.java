package com.sondertara.common.memory.leak;
...
import static com.sondertara.common.os.SystemPropertys.NEWLINE;
...
public class ResourceLeakDetector<T> {
    ...
    public ResourceLeakDetector(Class<?> resourceType, int samplingInterval) {
        this.resourceType = ReflectUtils.getSimpleClassName(resourceType);
    ...
    protected void reportUntracedLeak(String resourceType) {
        ...
        logger.error("LEAK: {} was not (close | stop | release | dispose, or other similar method) before it's garbage-collected. " +
                        ...
                        "See https://netty.io/wiki/reference-counted-objects.html for more information.",
                resourceType, PROP_LEVEL, Level.ADVANCED.name().toLowerCase(), ReflectUtils.getSimpleClassName(this));
    }
    ...
    private static final class DefaultResourceLeak<T> extends WeakReference<Object> implements ResourceLeakTracker<T> {
        ...
        DefaultResourceLeak(Object referent, ReferenceQueue<Object> refQueue, Set<DefaultResourceLeak> allLeaks) {
            ...
            trackedHash = ObjectUtils.id(referent);
            Objects.requireNonNull(allLeaks);
            allLeaks.add(this);
        ...
        public boolean close(T trackedObject) {
            ...
            assert trackedHash == ObjectUtils.id(trackedObject);
    ...
    public static void addExclusions(Class clz, String... methodNames) {
        ...
        for (Method method : ReflectUtils.getAllDeclaredMethods(clz, false)) {
