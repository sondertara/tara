...
import com.sondertara.common.timing.clock.Clock;
import com.sondertara.common.timing.clock.SystemClock;
...
public class DefaultMatcherWatchdog implements MatcherWatchdog {
    ...
    public DefaultMatcherWatchdog(long intervalInMills, long maxExecutionTime, BiConsumer<Long, Runnable> schedulerProxy) {
        this(intervalInMills, maxExecutionTime, new SystemClock(), schedulerProxy);
    }

    public DefaultMatcherWatchdog(long intervalInMills, long maxExecutionTime, Clock clock, BiConsumer<Long, Runnable> schedulerProxy) {
