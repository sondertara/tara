...
import com.sondertara.common.collection.iter.CopiedIter;
...
public abstract class StampedCache<K, V> extends AbstractCache<K, V> {
    ...
    public StampedCache(int capacity, long timeout) {
        super(capacity);

        this.capacity = capacity;
        setExpireAfterAccess(timeout);
    }
    ...
    @Override
    public Map<K, V> get(@NonNull Iterable<K> keys) {
