...
import com.sondertara.common.reflect.reference.ReferenceEntry;
...
public class Entry<K, V> extends ReferenceEntry<K, V> {
    ...
    Entry(K key, V value, boolean wrappedWhenStrong, int frequency) {
        super(key, ReferenceType.STRONG, value,  ReferenceType.STRONG, null, wrappedWhenStrong);
