...
public class Sqids {
    ...
    private Sqids(final Builder builder) {
        ...
        final Set<String> blockList = new HashSet<String>(builder.blockList);
        ...
        if (new HashSet<String>(Arrays.asList(alphabet.split(""))).size() != alphabetLength) {
        ...
        final Set<String> filteredBlockList = new HashSet<String>();
        final List<String> alphabetChars = new ArrayList<String>(Arrays.asList(alphabet.toLowerCase().split("")));
        for (String word : blockList) {
            if (word.length() >= MIN_BLOCK_LIST_WORD_LENGTH) {
                word = word.toLowerCase();
                List<String> wordChars = Arrays.asList(word.split(""));
                List<String> intersection = new ArrayList<String>(wordChars);
    ...
    private boolean isBlockedId(final String id) {
        final String lowercaseId = StringUtils.lowerCase(id);
    ...
    public static final class Builder {
         ...
         */
        public static final Set<String> DEFAULT_BLOCK_LIST = Sets.immutableSet(
                "1d10t",
                "1d1ot",
                "1di0t",
                "1diot",
        ...
        public Builder blockList(final Set<String> blockList) {
            if (blockList != null) {
                this.blockList = Collections.unmodifiableSet(new HashSet<String>(blockList));
            }
            return this;
        }
