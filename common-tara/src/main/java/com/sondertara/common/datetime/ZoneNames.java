...
class ZoneNames {
    ...
    private static final Map<String, String> zidToMzone = new HashMap<String, String>();
    private static final Map<String, String> mzoneToZid = new HashMap<String, String>();
    private static final Map<String, Map<String, String>> mzoneToZidL = new HashMap<String, Map<String, String>>();
