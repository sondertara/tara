...
public class DateStream extends CloneSupport<DateStream> implements Serializable {
    ...
    public DateStream() {
        this.c = LocalDateTimeUtils.calendar();
    }

    public DateStream(Date date) {
        Valid.notNull(date, "date is null");
        this.c = LocalDateTimeUtils.calendar(date);
    }
    ...
    public static DateStream of(Object o) {
        return new DateStream(LocalDateTimeUtils.date(o));
    }

    public static DateStream of(Object o, TimeZone timeZone) {
        return new DateStream(LocalDateTimeUtils.date(o), timeZone);
    }

    public static DateStream of(Object o, Locale locale) {
        return new DateStream(LocalDateTimeUtils.date(o), locale);
    }

    public static DateStream of(Object o, TimeZone timeZone, Locale locale) {
        return new DateStream(LocalDateTimeUtils.date(o), timeZone, locale);
    }
    ...
    public DateStream monthFirstDay() {
        LocalDateTimeUtils.beginOfMonth(c);
        return this;
    }
    ...
    public DateStream monthLastDay() {
        LocalDateTimeUtils.endOfMonth(c);
        return this;
    }
    ...
    public String format() {
        return LocalDateTimeUtils.format(c.getTime());
    }

    public String format(String pattern) {
        return LocalDateTimeUtils.format(c.getTime(), pattern);
    }

    public String format(Locale locale) {
        return LocalDateTimeUtils.format(c.getTime(), locale);
    }

    public String format(String pattern, Locale locale) {
        return LocalDateTimeUtils.format(c.getTime(), pattern, locale);
    }

    public String format(TimeZone timeZone) {
        return LocalDateTimeUtils.format(c.getTime(), timeZone);
    }

    public String format(String pattern, TimeZone timeZone) {
        return LocalDateTimeUtils.format(c.getTime(), pattern, timeZone);
    }

    public String format(TimeZone timeZone, Locale locale) {
        return LocalDateTimeUtils.format(c.getTime(), timeZone, locale);
    }

    public String format(String pattern, TimeZone timeZone, Locale locale) {
        return LocalDateTimeUtils.format(c.getTime(), pattern, timeZone, locale);
    }
    ...
    public boolean inFuture() {
        return LocalDateTimeUtils.inFuture(c.getTimeInMillis());
    }
    ...
    public boolean isLeapYear() {
        return LocalDateTimeUtils.isLeapYear(c);
    }
    ...
    public int getMonthLastDay() {
        return LocalDateTimeUtils.getMonthLastDay(c);
    }
