package com.sondertara.common.management.connector.server.impl;

import com.sondertara.common.collection.ArrayUtils;
import com.sondertara.common.management.connector.server.JMXConnectorServerWrapper;
...
public class RMIJMXConnectorServerWrapper implements JMXConnectorServerWrapper {
    ...
    public String[] getCiphers() {
        return ArrayUtils.copy(ciphers);
    }
    ...
    public String[] getProtocols() {
        return ArrayUtils.copy(protocols);
    }

    public void setProtocols(String[] protocols) {
        this.protocols = ArrayUtils.copy(protocols);
    }
