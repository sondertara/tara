...
public final class NativeLibraryLoader {
    ...
    public static void load(String originalName, ClassLoader loader) {
        ...
        if (url == null && JdkUtils.IS_MAC_OS) {
    ...
    private static void loadLibrary(final ClassLoader loader, final String name, final boolean absolute) {
        ...
        try {
            ...
            final Class<?> newHelper = tryToLoadClass(loader, NativeLibraryUtils.class);
        ...
        NativeLibraryUtils.loadLibrary(name, absolute);  // Fallback to local helper class.
    }
            ...
            return AccessController.doPrivileged(new PrivilegedAction<Class<?>>() {
                ...
                public Class<?> run() {
                    try {
                        ...
                        Method defineClass = ReflectUtils.getDeclaredMethod(ClassLoader.class, "defineClass", String.class,
                                byte[].class, int.class, int.class);
                        ReflectUtils.makeAccessible(defineClass);
