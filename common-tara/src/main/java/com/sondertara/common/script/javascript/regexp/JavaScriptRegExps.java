package com.sondertara.common.script.javascript.regexp;

import com.sondertara.common.regex.RegexUtils;
import com.sondertara.common.regex.RegexpMatcher;
import com.sondertara.common.script.ScriptUtils;
...
public class JavaScriptRegExps {
    ...
    public static RegexpMatcher getMatcher(String pattern, String src) {
        return RegexUtils.compile(pattern).matcher(src);
    }
    ...
    public boolean test(String str) {
        if (isIgnoreCase) {
            try {
                ...
                ScriptEngine engine = ScriptUtils.getJsEngine();
