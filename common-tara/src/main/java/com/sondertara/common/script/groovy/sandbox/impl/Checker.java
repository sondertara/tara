...
import static com.sondertara.common.script.groovy.sandbox.impl.ClosureSupport.BUILTIN_PROPERTIES;
...
//            return fakeCallSite(property.toString()).callGetProperty(receiver);
     ...
     *
     * @param op One of the assignment operators of {@link Types}
     */
     ...
     * a[i]++ / a[i]--
     *
     * @param op "next" for ++, "previous" for --. These names are defined by Groovy.
     */
     ...
     *
     * @param op One of the binary operators of {@link Types}
     *           //     * @see BinaryExpressionHelper#evaluateBinaryExpressionWithAssignment(String, BinaryExpression)
     */
