package com.sondertara.common.text.translate;
...
class NumericEntityUnescaper extends CharSequenceTranslator {
    ...
    public NumericEntityUnescaper(final OPTION... options) {
        if (options.length > 0) {
            this.options = EnumSet.copyOf(Lists.asList(options));
        } else {
            this.options = EnumSet.copyOf(Lists.asList(OPTION.semiColonRequired));
        }
    }
