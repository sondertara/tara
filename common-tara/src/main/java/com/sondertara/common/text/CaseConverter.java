...
public class CaseConverter {
	 ...
	 * @return converted string
	 */
	public static String convertToStartCase(String value,boolean firstCapitalize) {
		StringBuilder returnValue = new StringBuilder();
		value = value.toLowerCase();
		boolean makeNextUppercase = firstCapitalize;
	...
	public static String convertToCamelCase(String value) {
		...
		value = CaseConverter.convertToStartCase(value,false);
	...
	public static void main(String[] args) {
		String string = convertToCamelCase("ORG_ID");
		String string1 = convertToSnakeCase("ORG_ID");
