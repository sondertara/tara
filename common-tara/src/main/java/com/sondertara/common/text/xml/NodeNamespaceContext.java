...
public class NodeNamespaceContext implements NamespaceContext {
    ...
    private void reGroup() {
        if (prefixToNamespaceMap != null) {
            if(StringUtils.isNotBlank(defaultPrefix) && !defaultPrefix.equals(XMLConstants.XMLNS_ATTRIBUTE)){
            ...
            this.uriToNamespacesMap = CollectionUtils.groupBy(this.prefixToNamespaceMap.values(), new Function<Namespace, String>() {
                @Override
