...
public class TreeUtils {
     ...
     * @return 树形结构列表
     */
    public static <T extends ITreeNode<?, T>> List<T> generateTrees(List<T> nodes) {
     ...
     * @param nodes  所有树节点列表
     */
    public static <T extends ITreeNode<?, T>> void setChildren(T parent, List<T> nodes) {
     ...
     * @return 叶子节点
     */
    public static <T extends ITreeNode<?, T>> List<T> getLeafList(T parent) {
     ...
     * @param <T>      实际节点类型
     */
    public static <T extends ITreeNode<?, T>> void fillLeaf(T parent, List<T> leafList) {
     ...
     * @return the row list
     */
    public static <T extends ITreeNode<?, T>> List<List<String>> treeValueToRow(List<T> dataList, String... keys) {
    ...
    private static <T extends ITreeNode<?, T>> void iteratorNode(T root, Stack<String> row, List<List<String>> result,
                                                                 List<String> keys) {
