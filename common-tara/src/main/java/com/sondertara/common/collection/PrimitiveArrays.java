...
import com.sondertara.common.collection.sort.DualPivotQuicksort;
import com.sondertara.common.io.bytes.Bytes;
...
public class PrimitiveArrays {
    ...
    protected static final List<Class> PRIMITIVE_ARRAY_CLASSES = Lists.asList(Lists.asList(
            BYTE_ARRAY_CLASS,
            SHORT_ARRAY_CLASS,
            INT_ARRAY_CLASS,
            LONG_ARRAY_CLASS,
    ...
    public static <E> E[] wrap(Object o) {
        Valid.isTrue(ArrayUtils.isArray(o));
        if (isPrimitiveArray(o.getClass())) {
            int length = ArrayUtils.getLength(o);
            Class componentType = o.getClass().getComponentType();
            E[] array = (E[]) ArrayUtils.createArray(componentType, length);
    ...
    public static Boolean[] wrap(@Nullable final boolean[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Boolean.class, values.length, new Function<Integer, Boolean>() {
            @Override
    ...
    public static boolean[] unwrap(@Nullable final Boolean[] values, boolean resultNullable) {
        ...
        return createBooleanArray(values.length, new Function<Integer, Boolean>() {
            @Override
            public Boolean apply(Integer index) {
                return values[index];
            }
    ...
    public static Character[] wrap(@Nullable final char[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Character.class, values.length, new Function<Integer, Character>() {
            @Override
    ...
    public static char[] unwrap(@Nullable final Character[] values, boolean resultNullable) {
        ...
        return createCharArray(values.length, new Function<Integer, Character>() {
            @Override
            public Character apply(Integer index) {
                return values[index];
            }
    ...
    public static Byte[] wrap(@Nullable final byte[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Byte.class, values.length, new Function<Integer, Byte>() {
            @Override
    ...
    public static byte[] unwrap(@Nullable final Byte[] values, boolean resultNullable) {
        ...
        return createByteArray(values.length, new Function<Integer, Byte>() {
            @Override
            public Byte apply(Integer index) {
                return values[index];
            }
    ...
    public static Short[] wrap(@Nullable final short[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Short.class, values.length, new Function<Integer, Short>() {
            @Override
            public Short apply(Integer index) {
                return values[index];
            }
        });
    }
    ...
    public static short[] unwrap(@Nullable final Short[] values, boolean resultNullable) {
        ...
        return createShortArray(values.length, new Function<Integer, Short>() {
            @Override
    ...
    public static Integer[] wrap(@Nullable final int[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Integer.class, values.length, new Function<Integer, Integer>() {
            @Override
    ...
    public static int[] unwrap(@Nullable final Integer[] values, boolean resultNullable) {
        ...
        return createIntArray(values.length, new Function<Integer, Integer>() {
            @Override
            public Integer apply(Integer index) {
                return values[index];
            }
    ...
    public static Float[] wrap(@Nullable final float[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Float.class, values.length, new Function<Integer, Float>() {
            @Override
            public Float apply(Integer index) {
                return values[index];
            }
        });
    ...
    public static float[] unwrap(@Nullable final Float[] values, boolean resultNullable) {
        ...
        return createFloatArray(values.length, new Function<Integer, Float>() {
            @Override
            public Float apply(Integer index) {
                return values[index];
            }
    ...
    public static Long[] wrap(@Nullable final long[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Long.class, values.length, new Function<Integer, Long>() {
            @Override
            public Long apply(Integer index) {
                return values[index];
            }
        });
    }
    ...
    public static long[] unwrap(@Nullable final Long[] values, boolean resultNullable) {
        ...
        return createLongArray(values.length, new Function<Integer, Long>() {
            @Override
            public Long apply(Integer index) {
                return values[index];
            }
    ...
    public static Double[] wrap(@Nullable final double[] values, boolean resultNullable) {
        ...
        return ArrayUtils.createArray(Double.class, values.length, new Function<Integer, Double>() {
            @Override
    ...
    public static double[] unwrap(@Nullable final Double[] values, boolean resultNullable) {
        ...
        return createDoubleArray(values.length, new Function<Integer, Double>() {
            @Override
            public Double apply(Integer index) {
                return values[index];
            }
    ...
    public static byte[] createByteArray(int length, final byte initValue) {
        return createByteArray(length, new Function<Integer, Byte>() {
            @Override
            public Byte apply(Integer index) {
                return initValue;
            }
    ...
    public static byte[] createByteArray(int length, Function<Integer, Byte> initValueSupplier) {
        byte[] array = new byte[length];
        if (initValueSupplier != null) {
            for (int i = 0; i < length; i++) {
                array[i] = initValueSupplier.apply(i);
            }
        }
        return array;
    }
    ...
    public static short[] createShortArray(int length, final short initValue) {
        return createShortArray(length, new Function<Integer, Short>() {
            @Override
            public Short apply(Integer index) {
                return initValue;
            }
    ...
    public static short[] createShortArray(int length, Function<Integer, Short> initValueSupplier) {
    ...
    public static char[] createCharArray(int length, final char initValue) {
        return createCharArray(length, new Function<Integer, Character>() {
            @Override
            public Character apply(Integer index) {
                return initValue;
            }
    ...
    public static char[] createCharArray(int length, Function<Integer, Character> initValueSupplier) {
    ...
    public static int[] createIntArray(int length, final int initValue) {
        return createIntArray(length, new Function<Integer, Integer>() {
            @Override
            public Integer apply(Integer index) {
                return initValue;
            }
    ...
    public static int[] createIntArray(int length, Function<Integer, Integer> initValueSupplier) {
    ...
    public static long[] createLongArray(int length, final long initValue) {
        return createLongArray(length, new Function<Integer, Long>() {
            @Override
            public Long apply(Integer index) {
                return initValue;
            }
    ...
    public static long[] createLongArray(int length, Function<Integer, Long> initValueSupplier) {
    ...
    public static float[] createFloatArray(int length, final float initValue) {
        return createFloatArray(length, new Function<Integer, Float>() {
            @Override
            public Float apply(Integer index) {
                return initValue;
            }
    ...
    public static float[] createFloatArray(int length, Function<Integer, Float> initValueSupplier) {
    ...
    public static double[] createDoubleArray(int length, final Double initValue) {
        return createDoubleArray(length, new Function<Integer, Double>() {
            @Override
            public Double apply(Integer index) {
                return initValue;
            }
    ...
    public static double[] createDoubleArray(int length, Function<Integer, Double> initValueSupplier) {
    ...
    public static boolean[] createBooleanArray(int length, final boolean initValue) {
        return createBooleanArray(length, new Function<Integer, Boolean>() {
            @Override
            public Boolean apply(Integer index) {
                return initValue;
            }
    ...
    public static boolean[] createBooleanArray(int length, Function<Integer, Boolean> initValueSupplier) {
    ...
    public static short[] copy(final short[] values) {
        return createShortArray(values.length, new Function<Integer, Short>() {
            @Override
            public Short apply(Integer input) {
                return values[input];
            }
        });
    }
    ...
    public static void sort(int[] a, int fromIndex, int toIndex) {
        Valid.checkPositionIndexes(fromIndex, toIndex, a.length);
