package com.sondertara.common.collection.exclusion;
...
public class IncludeExcludeSet<T, P> implements Predicate<P> {
    ...
    public <SET extends Set<T>> IncludeExcludeSet(Class<SET> setClass) {
        try {
            ...
            if (inclusions instanceof Predicate) {
                ...
                includePredicate = new SetContainsPredicate(inclusions);
            }

            if (exclusions instanceof Predicate) {
                excludePredicate = (Predicate<P>) exclusions;
            } else {
                excludePredicate = new SetContainsPredicate(exclusions);
            }
    ...
    @SafeVarargs
    public final void addInclusions(T... element) {
    ...
    @SafeVarargs
    public final void addExclusions(T... element) {
