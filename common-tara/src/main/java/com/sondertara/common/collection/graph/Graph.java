...
public class Graph<T> {
    ...
    public boolean removeVertex(Vertex<T> v, boolean removeUnsharedOutgoing) {
        ...
        CollectionUtils.forEach(outgoingVertices, new Consumer<Vertex<T>>() {
            @Override
            public void accept(Vertex<T> vertex) {
                List<Vertex<T>> incomings = Lists.newArrayList(vertex.getIncomingVertices());
        ...
        List<Vertex<T>> list = CollectionUtils.reverse(willRemovedVertices);
        list.forEach(new Consumer<Vertex<T>>() {
            @Override
            public void accept(Vertex<T> vertex) {
                removeVertex(vertex);
            }
    ...
    public List<String> getVertexNames() {
        return StreamUtils.of(getVertices()).map(new Function<Vertex<T>, String>() {
            @Override
    ...
    public List<Edge<T>> getEdges() {
        return Lists.newArrayList(this.edges);
    }
