 ...
 */
package com.sondertara.common.collection.list;
...
public class LazyList<E> extends AbstractSerializableListDecorator<E> {
    ...
    private final transient Supplier<? extends E> factory;
     ...
     */
    public static <E> LazyList<E> lazyList(final List<E> list, final Supplier<? extends E> factory) {
     ...
     * @throws NullPointerException if list or factory is null
     */
    protected LazyList(final List<E> list, final Supplier<? extends E> factory) {
        super(list);
