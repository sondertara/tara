package com.sondertara.common.collection.sort;
...
public class TimSort<T> {
    ...
    private TimSort(T[] a, Comparator<? super T> c, T[] work, int workBase, int workLen) {
        ...
        if (work == null || workLen < tlen || workBase + tlen > work.length) {
            T[] newArray = (T[]) ArrayUtils.createArray(a.getClass().getComponentType(), tlen);
            tmp = newArray;
            tmpBase = 0;
            tmpLen = tlen;
        } else {
    ...
    public static <T> void sort(T[] a, Comparator<? super T> comparator) {
        sort(a, 0, a.length, comparator, null, 0, 0);
    }

    public static <T> void sort(T[] a, int fromIndex, Comparator<? super T> comparator) {
        sort(a, fromIndex, a.length, comparator, null, 0, 0);
    }

    public static <T> void sort(T[] a, int fromIndex, int endIndex, Comparator<? super T> comparator) {
        sort(a, fromIndex, endIndex, comparator, null, 0, 0);
    }
    ...
    public static <T> void sort(T[] a, int fromIndex, int endIndex, Comparator<? super T> comparator, T[] work, int workBase, int workLen) {
        ...
        comparator = comparator == null ? new ComparableComparator() : comparator;
         Assert.isTrue(fromIndex >= 0 && fromIndex <= endIndex && endIndex <= a.length, "invalid index, fromIndex:{}, endIndex:{}, length:{}", fromIndex, endIndex, a.length);
        ...
        if (nRemaining < MIN_MERGE) {
            int initRunLen = countRunAndMakeAscending(a, fromIndex, endIndex, comparator);
            binarySort(a, fromIndex, endIndex, fromIndex + initRunLen, comparator);
            return;
        }
         ...
         */
        TimSort<T> ts = new TimSort<T>(a, comparator, work, workBase, workLen);
        int minRun = minRunLength(nRemaining);
        do {
            // Identify next run
            int runLen = countRunAndMakeAscending(a, fromIndex, endIndex, comparator);
    ...
    private T[] ensureCapacity(int minCapacity) {
        if (tmpLen < minCapacity) {
            ...
            T[] newArray = (T[]) ArrayUtils.createArray(a.getClass().getComponentType(), newSize);
            tmp = newArray;
            tmpLen = newSize;
            tmpBase = 0;
        }
