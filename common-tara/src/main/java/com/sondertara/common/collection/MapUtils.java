...
public class MapUtils {
    ...
    public static <K, V, R> Map<K, R> map(Map<K, V> map, BiFunction<K, V, R> biFunction) {
        ...
        return map.entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey, m -> biFunction.apply(m.getKey(), m.getValue()), (l, r) -> l));
    }
     ...
     * @return {@link java.util.AbstractMap.SimpleEntry} 或者 {@link java.util.AbstractMap.SimpleImmutableEntry}
     *      */
