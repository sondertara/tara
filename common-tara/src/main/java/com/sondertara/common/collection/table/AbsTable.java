package com.sondertara.common.collection.table;

import com.sondertara.common.base.ObjectUtils;
import com.sondertara.common.collection.iter.TransIter;
    ...
    private class CellSet extends AbstractSet<Cell<R, C, V>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Cell) {
                ...
                if (null != row) {
                    return ObjectUtils.equals(row.get(cell.getColumnKey()), cell.getValue());
                }
            }
            return false;
        }
    ...
    private static class SimpleCell<R, C, V> implements Cell<R, C, V>, Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof Cell) {
                Cell<?, ?, ?> other = (Cell<?, ?, ?>) obj;
                return ObjectUtils.equals(rowKey, other.getRowKey())
                        && ObjectUtils.equals(columnKey, other.getColumnKey())
