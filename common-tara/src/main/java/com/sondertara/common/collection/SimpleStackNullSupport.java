 ...
 */
@SuppressWarnings({"checkstyle:VisibilityModifier","unchecked"})
public class SimpleStackNullSupport<T>
        implements List<T>, Stack<T> {
    @Override
    public int search(Object o) {
        return CollectionUtils.firstOccurrence(this, (T) o);
    }
    ...
    public Iterator<T> iterator() {
        return new ReverseListIterator<T>(Lists.newArrayList(elems));
    }
    ...
    public <T> T[] toArray(final T[] a) {
        return Lists.newArrayList(elems).toArray(a);
    }
