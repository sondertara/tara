...
import com.sondertara.common.collection.iter.UnmodifiableListIterator;
import com.sondertara.common.collection.iter.WrappedIterator;
...
public class ImmutableArrayList<E> extends AbstractList<E> {
    ...
    public ImmutableArrayList(List<E> list){
        array = list instanceof  ArrayList ? (ArrayList<E>)list: Lists.newArrayList(list);
    }

    public ImmutableArrayList(Iterable<E> iterable){
        array = Lists.newArrayList(iterable);
    }
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        return Lists.asList(super.subList(fromIndex, toIndex), false);
    }
