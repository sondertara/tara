...
public class ScheduledThreadPoolDelegate extends ScheduledThreadPoolExecutor {
    ...
    public ScheduledThreadPoolDelegate(TpExecutorProperties threadPoolConfigure) {
        this(threadPoolConfigure.getCorePoolSize(), new DefaultThreadFactory(threadPoolConfigure.getKey(), threadPoolConfigure.isDaemon()), threadPoolConfigure.getRejectedExecutionHandler());
