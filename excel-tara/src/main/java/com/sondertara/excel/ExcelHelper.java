...
import com.sondertara.excel.parser.DataVariableParserVisitor;
import com.sondertara.excel.parser.VariableParserLexer;
import com.sondertara.excel.parser.VariableParserParser;
import com.sondertara.excel.tablemodel.Cell;
import com.sondertara.excel.tablemodel.CellStyle;
import com.sondertara.excel.tablemodel.ExcelWorkbook;
import com.sondertara.excel.tablemodel.Font;
import com.sondertara.excel.tablemodel.MergedRegion;
import com.sondertara.excel.tablemodel.Row;
import com.sondertara.excel.tablemodel.SheetTable;
...
public class ExcelHelper {
    ...
    public static ExcelWorkbook createWorkbook(byte[] bytes) throws IOException {
        ...
        return new ExcelWorkbook(new SXSSFWorkbook(xssfWorkbook));
    }
    ...
    public static SheetTable getSheetTable(byte[] bytes, int sheetIndex) throws IOException {
        ...
        SXSSFWorkbook xssfWorkbook = new SXSSFWorkbook(workbook);
    ...
    public static SheetTable getSheetTable(byte[] bytes, String sheetName) throws IOException {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bytes);
        SXSSFWorkbook xssfWorkbook = new SXSSFWorkbook(new XSSFWorkbook(byteArrayInputStream));
    ...
    public static Object parseCellVariable(Object data, String cellVariableName) {
        ...
        for (VariableParserParser.VariableContext variableContext : parser.variableExpr().variable()) {
            ...
            List<VariableParserParser.ArrayIdxContext> arrayIdxContexts = variableContext.arrayIdx();
            for (VariableParserParser.ArrayIdxContext arrayIdxContext : arrayIdxContexts) {
