...
public class Worksheet {
	...
	/* set page orientation for the print setup */
        ...
        if (header.get(Position.LEFT) != null) {
            writer.append(header.get(Position.LEFT));
        }
        if (header.get(Position.CENTER) != null) {
            writer.append(header.get(Position.CENTER));
        }
        if (header.get(Position.RIGHT) != null) {
            writer.append(header.get(Position.RIGHT));
        }
        writer.append("</oddHeader>");
        writer.append("<oddFooter>");
        if (footer.get(Position.LEFT) != null) {
            writer.append(footer.get(Position.LEFT));
        }
        if (footer.get(Position.CENTER) != null) {
            writer.append(footer.get(Position.CENTER));
        }
        if (footer.get(Position.RIGHT) != null) {
            writer.append(footer.get(Position.RIGHT));
        }
