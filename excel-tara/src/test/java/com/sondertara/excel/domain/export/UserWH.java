 ...
 * @author huangxiaohu
 */
@ExcelExport(sheetName = "用户数据", titleRowHeight = 100)
public class UserWH {

    @ExcelExportField(colIndex = 1, colName = "姓名",colWidth = 100)
    private String name;
    ...
    public String toString() {
        return "UserWH{" + "name='" + name + '\'' + ", age=" + age + ", birth=" + birth + ", height=" + height + '}';
    }
}
