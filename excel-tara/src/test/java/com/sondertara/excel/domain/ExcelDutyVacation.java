...
public class ExcelDutyVacation {
    ...
    @ExcelDataFormat
    @ExcelImportField(colIndex = 3, allowBlank = false, dataFormat = @ExcelDataFormat("yyyy/MM/dd"))
    ...
    @ExcelImportField(colIndex = 4, allowBlank = false, dataFormat = @ExcelDataFormat("yyyy/MM/dd"))
    private Date endDate;

    @ExcelExportField(colIndex = 5, colName = "备注")
    @ExcelImportField(colIndex = 5)
