...
@ExcelExport(sheetName = "用户数据",bindType = ExcelColBindType.DEF_ORDER)
public class User {
    @ExcelExportField(colIndex = 2, colName = {"基本信息","年龄","测试"})
    private Integer age;
    @ExcelExportField(colIndex = 1, colName = {"基本信息","姓名"},autoMerge = true)
    private String name;
