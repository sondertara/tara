...
public class FastExcelWriterTest {
    ...
    public void simpleTest() {
        try (OutputStream os = Files.newOutputStream(Paths.get("Fast-test.xlsx"))) {
            ...
            ws.range(excelHeaderVo.getTop(), excelHeaderVo.getRight() - 1, excelHeaderVo.getBottom() - 1, excelHeaderVo.getLeft()).style().fillColor(excelHeaderVo.getFillColor())
                    .horizontalAlignment("center")
                    .verticalAlignment("center")
                    .bold().borderStyle(BorderStyle.MEDIUM).set();
