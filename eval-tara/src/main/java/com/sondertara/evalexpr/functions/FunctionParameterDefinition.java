...
*/
package com.sondertara.evalexpr.functions;
...
public class FunctionParameterDefinition {
   ...
   *
   * @see com.sondertara.evalexpr.functions.basic.MinFunction for an example.
   */
  boolean isVarArg;

  /**
   * Set to true, the parameter will not be evaluated in advance, but the corresponding {@link
   * com.sondertara.evalexpr.parser.ASTNode} will be passed as a parameter value.
   *
   * @see com.sondertara.evalexpr.functions.basic.IfFunction for an example.
   */
  boolean isLazy;
