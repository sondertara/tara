...
import org.cherubim.common.util.httpclient.common.HttpHeader;
import org.cherubim.common.util.httpclient.common.HttpResult;
...
public class Demo {
    ...
    public static void main(String[] args) throws HttpProcessException, FileNotFoundException {
        ...
        //最简单的使用：
        String html = HttpClientUtil.get(HttpConfig.custom().url(url).client(HttpClientBuilder.custom().sslpv(SSLs.SSLProtocolVersion.TLSv1_2).ssl().build()));
        ...
        HttpClientBuilder hcb = HttpClientBuilder.custom()
                //.timeout(1000) 		//超时
