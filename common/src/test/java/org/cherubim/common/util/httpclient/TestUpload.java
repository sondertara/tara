...
import org.cherubim.common.util.httpclient.common.HttpCookies;
...
//		String[] filePaths = {"D:\\中国.txt","D:\\111.txt","C:\\Users\\160049\\Desktop\\中国.png"};//待上传的文件路径
        String[] filePaths = {"baidu.png"};//待上传的文件路径
    ...
    private static HttpConfig prepareUpload() throws HttpProcessException {
        ...
        //打开主页
        String s = HttpClientUtil.get(config.map(null).url(indexUrl));
